...
* *Format:* "Dear Professor, just to recap our meeting: I will complete the analysis by Friday. We agreed that if this yields results, I will draft the methods section as first author."  
...
Authorship Memorandums:  
At the start of any collaborative project, advocate for a simple Authorship Memorandum of Understanding (MOU). This document tentatively lists the author order and the specific roles (e.g., Data Curation, Formal Analysis, Writing) assigned to each contributor. This is not a legal contract, but a project management tool that sets clear expectations.
...
* [**Protocol A: Computational Workflow**](https://www.google.com/search?q=protocol_computational.md) (Code-heavy).  
* [**Protocol B: Manuscript Workflow**](https://www.google.com/search?q=protocol_manuscript.md) (Document-heavy).